...
void Chat::login()
{
	...
	do
	{
		...
		if (currentUser_ == nullptr || (password != currentUser_->getUserPassword()))
		{
			...
			std::cout << "\033[31m" << "(0)exit " << "\033[0m" << "or (any key)repeat: ";
			std::cin >> operation;
...
void Chat::showLoginMenu()
{
	...
	do
	{
		std::cout << "\033[36m" << "(1)Login" << std::endl;
		std::cout << "(2)signUp" << std::endl;
		std::cout << "\033[31m" << "(0)shutDown" << std::endl;
...
void Chat::showUserMenu()
{
	...
	while (currentUser_)
	{
		std::cout << "\033[32m" << "Menu: (1) Show chat; (2) Add message; (3) Users;" << "\033[31m" << "(0) Log out.";

		std::cout << std::endl << "\033[32m" << ">> " << "\033[0m";
		std::cin >> operation;
...
void Chat::showAllUersName() const
{
